...
<head>
  ...
  <title>End Term Officials</title>
  ...
  function displayOfficials(data) {
    ...
    data.forEach((official, index) => {
      ...
      row.innerHTML = `
        ...
        <td class="text-center align-middle">
          <button class="btn btn-sm bg-white rmvBtn"><i class="nav-icon fas fa-solid fa-rotate-left text-danger"></i></button>
        </td>
      `;
      ...
      if (e.target.closest(".rmvBtn")) {
        Swal.fire({
          ...
          text: 'You cannot return this end-termed official to the list of officials.',
