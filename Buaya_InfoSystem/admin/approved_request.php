...
.modal-body::-webkit-scrollbar-thumb {
  background:rgb(0, 34, 144); /* Darker thumb */
  border-radius: 10px;
}

/* Scrollbar Thumb on Hover */
.modal-body ::-webkit-scrollbar-thumb:hover {
  background: rgb(0, 34, 144); /* Even darker when hover */
}
...
.tooltip-container .tooltip-text {
    visibility: hidden;
    width: 130px;
    background-color:rgb(75, 211, 186);
    color: #fff;
    text-align: center;
    border-radius: 6px;
    padding: 5px 2px;
...
/* table */
 ...
 /* Modal Enhancement Styles */
        ...
        .status-field {
            background: linear-gradient(135deg, #81D5C6 0%, #A8E6CF 100%) !important;
            color: white !important;
            font-weight: 600;
        ...
        <div class="container-fluid  p-2">
            <div class="card p-0">
                <div class="col p-2 elevation-2 d-flex justify-content-between">
                    ...
                    <div class="col p-2">
                        <div class="container-fluid p-2 elevation-2"  style="border:none; border-radius: 10px; ">
...
<!-- VIEW OF PROFILE MODAL IF STATUS IS ACCEPTED -->
<div class="modal fade font-inter animate-fade-in" id="newModalPositionAccepted" data-backdrop="static" data-keyboard="false" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-personal">First Name</div>
                            <div class="field-value" id="fname">Jay Mike</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-personal">Last Name</div>
                            <div class="field-value" id="lname">Palang</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-personal">Middle Name</div>
                            <div class="field-value" id="mname">Empenado</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-personal">Suffix</div>
                            <div class="field-value" id="suffix">Jr</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-calendar">Date of Birth</div>
                            <div class="field-value" id="date_of_birth">2012-22-12</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-location">Place of Birth</div>
                            <div class="field-value" id="place_of_birth">Kolambugan, Lanao Del Norte</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-contact">Email</div>
                            <div class="field-value" id="email">jaymikesagaral@gmail.com</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-contact">Contact Number</div>
                            <div class="field-value" id="contactNum">093237662256</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-calendar">Date Requested</div>
                            <div class="field-value" id="dateRequested">12-21-2003</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-certificate">Certificate</div>
                            <div class="field-value" id="certificateRequested">Barangay Clearance</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-calendar">Years of Residence</div>
                            <div class="field-value" id="yrs_of_residence">10</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-personal">Civil Status</div>
                            <div class="field-value" id="civil_status">Single</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-status">Status</div>
                            <div class="field-value status-field" id="status">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="field-group">
                            <div class="field-label icon-purpose">Purpose</div>
                            <div class="field-value" id="purpose">Job Application</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="field-group">
                            <div class="field-label icon-message">Message</div>
                            <div class="field-value" id="message" style="min-height: 80px; align-items: flex-start;">
                                CHUchuchuchuccoahcoasflhJDFHLKJSFL
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-calendar">Date Issued</div>
                            <div class="field-value" id="dateIssued">12-21-2003</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="field-group">
                            <div class="field-label icon-calendar">Date Issued Expiration</div>
                            <div class="field-value" id="dateIssuedExpiration">12-25</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="action-btn btn-close" id="closeModalBtn" data-dismiss="modal">
                 ...
                 <!-- Add this new Claimed button -->
                <button type="button" class="action-btn btn-claimed" id="claimModalBtn">
...
<script>
    // Main script for handling approved requests
    document.addEventListener('DOMContentLoaded', function() {
        // Initialize by fetching approved requests
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.view-btn')) {
                ...
                const requestId = viewBtn.getAttribute('data-id');
            ...
            if (e.target.closest('.print-btn')) {
                ...
                const requestId = printBtn.getAttribute('data-id');
                const printUrl = `print_document.php?id=${requestId}`;
                window.open(printUrl, '_blank');
            }
        });

        // Claim button in modal
        document.getElementById('claimModalBtn').addEventListener('click', function() {
            const requestId = this.getAttribute('data-id');
            markRequestAsClaimed(requestId);
        });
    });
        ...
        fetch('../views/admin/get_approved_request.php')
            ...
            .then(data => {
                ...
                if (data.requests && data.requests.length > 0) {
                    // Store requests globally for later access
                    ...
                    data.requests.forEach(request => {
                        ...
                        row.innerHTML = `
                            <td class="text-center align-middle name-cell">${escapeHtml(request.full_name)}</td>
                            <td class="text-center align-middle purpose-cell">${escapeHtml(request.req_purpose)}</td>
                            <td class="text-center align-middle">
                                <span class="date-badge">${escapeHtml(request.req_requested_date)}</span>
                            </td>
                            <td class="text-center align-middle">
                                <span class="certificate-badge">${escapeHtml(request.cer_type_name)}</span>
                            </td>
                            <td class="text-center align-middle">
                                <span class="status-badge ${request.req_claim_status === 'claimed' ? 'status-claimed' : 'status-approved'}">
                                    <i class="fas ${request.req_claim_status === 'claimed' ? 'fa-check-double' : 'fa-check-circle'}"></i>
                                    ${request.req_claim_status === 'claimed' ? 'Claimed' : 'Approved'}
                                </span>
                            </td>
                            <td class="text-center align-middle">
                                <button type="button" class="action-btn view-btn" 
                                    data-id="${escapeHtml(request.req_id)}">
            ...
            .catch(error => {
                ...
                document.getElementById('requestTableBody').innerHTML = 
                    `<tr><td colspan="6" class="text-center">Error loading data: ${escapeHtml(error.message)}</td></tr>`;
            });
    }
    ...
    function showRequestData(requestId) {
        ...
        if (request) {
            ...
            document.getElementById('date_of_birth').textContent = request.req_date_of_birth || 'N/A';
            ...
            document.getElementById('dateRequested').textContent = request.req_requested_date || 'N/A';
            ...
            document.getElementById('dateIssued').textContent = request.req_date_issued || 'N/A';
            document.getElementById('dateIssuedExpiration').textContent = request.req_date_expiration || 'N/A';
            document.getElementById('message').textContent = request.req_message || 'No message provided';
            
            // Set status display - now checking req_claim_status instead of req_status
            const statusElement = document.getElementById('status');
            if (request.req_claim_status === 'claimed') {
                statusElement.innerHTML = '<i class="fas fa-check-double"></i> Claimed';
                statusElement.className = 'field-value status-field status-claimed';
            } else {
                statusElement.innerHTML = '<i class="fas fa-check-circle"></i> Approved';
                statusElement.className = 'field-value status-field status-approved';
            }
            
            // Configure Claim button
            const claimBtn = document.getElementById('claimModalBtn');
            claimBtn.setAttribute('data-id', request.req_id);
            
            if (request.req_claim_status === 'claimed') {
                claimBtn.disabled = true;
                claimBtn.innerHTML = '<i class="fa-solid fa-check-double"></i> Already Claimed';
            } else {
                claimBtn.disabled = false;
                claimBtn.innerHTML = '<i class="fa-solid fa-check-circle"></i> Mark as Claimed';
            }
            
            // Show modal with animation
            $('#newModalPositionAccepted').modal('show');
        } else {
            Swal.fire({
                icon: 'error',
                title: 'Request Not Found',
                text: 'The requested details could not be found.',
                confirmButtonColor: '#FF453F'
            });
        }
    }

    // Mark request as claimed
    function markRequestAsClaimed(requestId) {
        Swal.fire({
            title: 'Confirm Document Claim',
            text: 'Are you sure the resident has claimed this document?',
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            title: 'Success!',
                            text: 'Document marked as claimed successfully',
                            icon: 'success',
                        ...
                        // Update status in modal - now checking req_claim_status
                        const statusElement = document.getElementById('status');
                        statusElement.innerHTML = '<i class="fas fa-check-double"></i> Claimed';
                        statusElement.className = 'field-value status-field status-claimed';
                        
                        // Update status in table - now checking req_claim_status
                        updateRequestStatusInTable(requestId, 'claimed');
                    } else {
    ...
    // Update request status in the table - now checking req_claim_status
    function updateRequestStatusInTable(requestId, status) {
        const rows = document.querySelectorAll('#requestTableBody tr');
        rows.forEach(row => {
            if (row.getAttribute('data-id') == requestId) {
                const statusBadge = row.querySelector('.status-badge');
                if (statusBadge) {
                    statusBadge.innerHTML = `
                        <i class="fas ${status === 'claimed' ? 'fa-check-double' : 'fa-check-circle'}"></i>
                        ${status === 'claimed' ? 'Claimed' : 'Approved'}
                    `;
                    statusBadge.className = `status-badge ${status === 'claimed' ? 'status-claimed' : 'status-approved'}`;
                }
            }
        });
    }
